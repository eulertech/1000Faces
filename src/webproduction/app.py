...
@app.route('/results/teambuilder/<uuid>', methods=['GET'])
def results(uuid):
    title = 'Result'
...
@app.route('/results/projectrecommendation/<uuid>', methods=['GET'])
def results(uuid):
   title = 'Result'
   data = get_file_content(uuid)
   return render_template('layouts/results.html',
...
@app.route('/results/teamrecommendation/<uuid>', methods=['GET'])
def results(uuid):
   title = 'Result'
   data = get_file_content(uuid)
   return render_template('layouts/results.html',
